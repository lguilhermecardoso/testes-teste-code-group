...
})({"bVbuL":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 64569;
...
var _userJs = require("./pages/user.js");
var _repositoryJs = require("./pages/repository.js");
const app = document.getElementById('app');
(0, _routerJs.on)('/', ()=>(0, _homeJs.renderHome)(app));
(0, _routerJs.on)('/user/:username', ({ username })=>(0, _userJs.renderUser)(app, {
        username
    }));
(0, _routerJs.on)('/repo/:fullName*', ({ fullName })=>(0, _repositoryJs.renderRepository)(app, {
        fullName
    }));
(0, _routerJs.startRouter)();

},{"./router.js":"5D30b","./pages/home.js":"6MgRP","./pages/user.js":"jRFBF","./pages/repository.js":"gD9Pt"}],"5D30b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "on", ()=>on);
parcelHelpers.export(exports, "navigate", ()=>navigate);
parcelHelpers.export(exports, "startRouter", ()=>startRouter);
const routes = {};
...
},{}],"6MgRP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function renderHome(app) {
    ...
    <div class="search-wrapper">
      ...
      <p>Busque um usu\xe1rio para ver o perfil e os reposit\xf3rios.</p>
      <form id="search-form">
  ...
  `;
    ...
    form.addEventListener('submit', (e)=>{
        ...
        if (!username) {
            errorEl.textContent = "Digite um nome de usu\xe1rio.";
            errorEl.style.display = 'block';
            return;
        }
        errorEl.style.display = 'none';
        (0, _routerJs.navigate)(`/user/${encodeURIComponent(username)}`);
    });
}

},{"../router.js":"5D30b","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jRFBF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderUser", ()=>renderUser);
var _apiJs = require("../api.js");
var _userCardJs = require("../components/userCard.js");
var _repoListJs = require("../components/repoList.js");
var _spinnerJs = require("../components/spinner.js");
async function renderUser(app, { username }) {
    app.innerHTML = `
    <div class="mb-3">
    ...
    ${(0, _spinnerJs.renderSpinner)()}
  `;
    try {
        const [user, repos] = await Promise.all([
            (0, _apiJs.fetchUser)(username),
            (0, _apiJs.fetchRepos)(username)
        ]);
        app.innerHTML = `
      <div class="mb-3">
        <a href="#/" class="btn btn-sm btn-outline-secondary">
      ...
      <div class="row g-4">
        <div class="col-md-4">
          ${(0, _userCardJs.renderUserCard)(user)}
        </div>
        <div class="col-md-8">
    ...
    `;
        const repoListEl = app.querySelector('#repo-list');
        (0, _repoListJs.renderRepoList)(repos, repoListEl);
    } catch (err) {
        const msg = err.response?.status === 404 ? `Usu\xe1rio <strong>${username}</strong> n\xe3o encontrado.` : 'Erro ao conectar com a API do GitHub. Tente novamente.';
        app.innerHTML = `
      <div class="mb-3">
        <a href="#/" class="btn btn-sm btn-outline-secondary">
          <i class="bi bi-arrow-left me-1"></i>Voltar
...
},{"../api.js":"4yEOZ","../components/userCard.js":"8qwhV","../components/repoList.js":"lwD0F","../components/spinner.js":"f9spB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4yEOZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchUser", ()=>fetchUser);
parcelHelpers.export(exports, "fetchRepos", ()=>fetchRepos);
parcelHelpers.export(exports, "fetchRepo", ()=>fetchRepo);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const github = (0, _axiosDefault.default).create({
...
},{"../utils.js":"jI6DP","./AxiosHeaders.js":"9EzTj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9EzTj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"../utils.js":"jI6DP","../helpers/parseHeaders.js":"H8RrA","../helpers/sanitizeHeaderValue.js":"hgIfL","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"H8RrA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"../utils.js":"jI6DP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hgIfL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = (config)=>{
    ...
    newConfig.url = (0, _buildURLJsDefault.default)((0, _buildFullPathJsDefault.default)(baseURL, url, allowAbsoluteUrls), config.params, config.paramsSerializer);
    ...
    return async (config)=>{
        ...
        try {
            ...
            if (hasMaxBodyLength && method !== 'get' && method !== 'head') {
                ...
                if (typeof outboundLength === 'number' && isFinite(outboundLength) && outboundLength > maxBodyLength) throw new (0, _axiosErrorJsDefault.default)('Request body larger than maxBodyLength limit', (0, _axiosErrorJsDefault.default).ERR_BAD_REQUEST, config, request);
            }
            ...
            if (hasMaxContentLength) {
                const declaredLength = (0, _utilsJsDefault.default).toFiniteNumber(response.headers.get('content-length'));
...
},{"../platform/index.js":"626Zd","../utils.js":"jI6DP","../core/AxiosError.js":"7z85x","../helpers/composeSignals.js":"fy9c7","../helpers/trackStream.js":"6dI08","../core/AxiosHeaders.js":"9EzTj","../helpers/progressEventReducer.js":"6rzPu","../helpers/resolveConfig.js":"3RDMa","../core/settle.js":"2vmJg","../helpers/estimateDataURLDecodedBytes.js":"918ps","../env/data.js":"9SLyZ","../helpers/sanitizeHeaderValue.js":"hgIfL","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fy9c7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _canceledErrorJs = require("../cancel/CanceledError.js");
var _canceledErrorJsDefault = parcelHelpers.interopDefault(_canceledErrorJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"918ps":[function(require,module,exports,__globalThis) {
/**
...
var Buffer = require("620f4bc93a83451b").Buffer;
...
},{"620f4bc93a83451b":"bCaf4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9SLyZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "VERSION", ()=>VERSION);
...
},{"../env/data.js":"9SLyZ","../core/AxiosError.js":"7z85x","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kSqbX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8qwhV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderUserCard", ()=>renderUserCard);
function renderUserCard(user) {
    const email = user.email ? `<span class="stat-item"><i class="bi bi-envelope me-1"></i>${user.email}</span>` : '';
    ...
    <div class="profile-card">
      ...
      <div class="d-flex flex-wrap gap-3">
        <span class="stat-item">
          ...
          <strong>${formatCount(user.followers)}</strong> seguidores
        </span>
        <span class="stat-item">
          <i class="bi bi-person-check me-1"></i>
          <strong>${formatCount(user.following)}</strong> seguindo
        </span>
        ${email}
      </div>
    </div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lwD0F":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderRepoList", ()=>renderRepoList);
const LANG_COLORS = {
    JavaScript: '#f1e05a',
    TypeScript: '#3178c6',
    Python: '#3572A5',
...
function _render(container) {
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
      <span class="text-muted" style="font-size:0.875rem">
        ${reposCache.length} reposit\xf3rio${reposCache.length !== 1 ? 's' : ''}
      </span>
      <div class="sort-controls">
        <span class="text-muted me-1" style="font-size:0.82rem">Ordenar por:</span>
        ${sortBtn('stars', 'Estrelas')}
        ${sortBtn('name', 'Nome')}
        ${sortBtn('updated_at', "Atualiza\xe7\xe3o")}
        <button class="btn btn-sm btn-sort btn-outline-secondary ms-1" id="btn-order" title="Inverter ordem">
          <i class="bi bi-arrow-${currentOrder === 'desc' ? 'down' : 'up'}"></i>
        </button>
      </div>
    </div>
  `;
    const cards = sorted.map((repo)=>repoCard(repo)).join('');
    container.innerHTML = `
    <div id="sort-controls-wrapper">${controls}</div>
    <div class="d-flex flex-column gap-2">${cards}</div>
  `;
    container.querySelectorAll('[data-sort]').forEach((btn)=>{
        btn.addEventListener('click', ()=>{
            if (currentSort === btn.dataset.sort) currentOrder = currentOrder === 'desc' ? 'asc' : 'desc';
            else {
                currentSort = btn.dataset.sort;
                currentOrder = btn.dataset.sort === 'name' ? 'asc' : 'desc';
            }
            _render(container);
        });
    });
...
function sortBtn(key, label) {
    const active = currentSort === key ? 'btn-secondary' : 'btn-outline-secondary';
    return `<button class="btn btn-sm btn-sort ${active}" data-sort="${key}">${label}</button>`;
}
function comparator() {
    return (a, b)=>{
        let valA, valB;
...
function repoCard(repo) {
    ...
    const langColor = lang ? LANG_COLORS[lang] || '#8b8b8b' : null;
    const langBadge = lang ? `<span><span class="lang-dot" style="background:${langColor}"></span>${lang}</span>` : '';
    const desc = repo.description ? `<div class="repo-desc">${repo.description}</div>` : '';
    const hash = `#/repo/${encodeURIComponent(repo.full_name)}`;
    return `
    <a href="${hash}" class="repo-card">
      <div class="repo-name">${repo.name}</div>
      ${desc}
      <div class="repo-meta">
        <span class="stars"><i class="bi bi-star-fill me-1"></i>${repo.stargazers_count.toLocaleString()}</span>
        ${langBadge}
      </div>
    </a>
  `;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f9spB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gD9Pt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderRepository", ()=>renderRepository);
var _apiJs = require("../api.js");
var _spinnerJs = require("../components/spinner.js");
async function renderRepository(app, { fullName }) {
    app.innerHTML = `
    <div class="mb-3">
      <a id="back-btn" href="#/" class="btn btn-sm btn-outline-secondary">
        <i class="bi bi-arrow-left me-1"></i>Voltar
      </a>
    </div>
    ${(0, _spinnerJs.renderSpinner)()}
  `;
    try {
        const repo = await (0, _apiJs.fetchRepo)(fullName);
        const owner = repo.owner.login;
        app.innerHTML = `
      <div class="mb-3">
        <a href="#/user/${encodeURIComponent(owner)}" class="btn btn-sm btn-outline-secondary">
          <i class="bi bi-arrow-left me-1"></i>Voltar para ${owner}
        </a>
      </div>
      <div class="repo-detail-card">
        <div class="d-flex align-items-center gap-2 mb-1">
          ...
          />
          <span class="text-muted" style="font-size:0.9rem">${owner}</span>
        </div>

        <h2 class="repo-title mb-2">${repo.name}</h2>

        ${repo.description ? `<p class="text-muted mb-3">${repo.description}</p>` : ''}

        <div class="d-flex flex-wrap gap-2 mb-4">
          <span class="stat-badge">
            <i class="bi bi-star-fill text-warning"></i>
            ${repo.stargazers_count.toLocaleString()} estrelas
          </span>
          ${repo.language ? `
          <span class="stat-badge">
        ...
        <a
          ...
          class="btn btn-dark"
        >
          <i class="bi bi-box-arrow-up-right me-2"></i>Ver no GitHub
        </a>
      </div>
    `;
    } catch (err) {
      ...
      <div class="error-box">
        <span class="icon">\u{1F615}</span>
        <p>Reposit\xf3rio n\xe3o encontrado.</p>
      </div>
    `;
    }
}

},{"../api.js":"4yEOZ","../components/spinner.js":"f9spB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["bVbuL","lhpGb"], "lhpGb", "parcelRequireca4e", {})

//# sourceMappingURL=teste-code-group.b828852a.js.map
